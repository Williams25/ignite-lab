...
export type Create_SubscriberMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type Create_SubscriberMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };

export type Get_LessonsQueryVariables = Exact<{ [key: string]: never; }>;


export type Get_LessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, lessonType: LessonType, title: string, slug?: string | null, availableAt?: any | null }> };

export type Get_Lesson_By_SlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type Get_Lesson_By_SlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', description?: string | null, videoId: string, title: string, teacher?: { __typename?: 'Teacher', name: string, bio: string, avatarURL: string } | null } | null };


export const Create_SubscriberDocument = gql`
  ...
  createSubscriber(data: {name: $name, email: $email}) {
    ...
    `;
export type Create_SubscriberMutationFn = Apollo.MutationFunction<Create_SubscriberMutation, Create_SubscriberMutationVariables>;

/**
 * __useCreate_SubscriberMutation__
 *
 * To run a mutation, you first call `useCreate_SubscriberMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreate_SubscriberMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createSubscriberMutation, { data, loading, error }] = useCreate_SubscriberMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCreate_SubscriberMutation(baseOptions?: Apollo.MutationHookOptions<Create_SubscriberMutation, Create_SubscriberMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<Create_SubscriberMutation, Create_SubscriberMutationVariables>(Create_SubscriberDocument, options);
      }
export type Create_SubscriberMutationHookResult = ReturnType<typeof useCreate_SubscriberMutation>;
export type Create_SubscriberMutationResult = Apollo.MutationResult<Create_SubscriberMutation>;
export type Create_SubscriberMutationOptions = Apollo.BaseMutationOptions<Create_SubscriberMutation, Create_SubscriberMutationVariables>;
export const Get_LessonsDocument = gql`
    query GET_LESSONS {
...
/**
 * __useGet_LessonsQuery__
 *
 * To run a query within a React component, call `useGet_LessonsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGet_LessonsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGet_LessonsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGet_LessonsQuery(baseOptions?: Apollo.QueryHookOptions<Get_LessonsQuery, Get_LessonsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<Get_LessonsQuery, Get_LessonsQueryVariables>(Get_LessonsDocument, options);
      }
export function useGet_LessonsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Get_LessonsQuery, Get_LessonsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<Get_LessonsQuery, Get_LessonsQueryVariables>(Get_LessonsDocument, options);
        }
export type Get_LessonsQueryHookResult = ReturnType<typeof useGet_LessonsQuery>;
export type Get_LessonsLazyQueryHookResult = ReturnType<typeof useGet_LessonsLazyQuery>;
export type Get_LessonsQueryResult = Apollo.QueryResult<Get_LessonsQuery, Get_LessonsQueryVariables>;
export const Get_Lesson_By_SlugDocument = gql`
...
/**
 * __useGet_Lesson_By_SlugQuery__
 *
 * To run a query within a React component, call `useGet_Lesson_By_SlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGet_Lesson_By_SlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGet_Lesson_By_SlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGet_Lesson_By_SlugQuery(baseOptions?: Apollo.QueryHookOptions<Get_Lesson_By_SlugQuery, Get_Lesson_By_SlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<Get_Lesson_By_SlugQuery, Get_Lesson_By_SlugQueryVariables>(Get_Lesson_By_SlugDocument, options);
      }
export function useGet_Lesson_By_SlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Get_Lesson_By_SlugQuery, Get_Lesson_By_SlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<Get_Lesson_By_SlugQuery, Get_Lesson_By_SlugQueryVariables>(Get_Lesson_By_SlugDocument, options);
        }
export type Get_Lesson_By_SlugQueryHookResult = ReturnType<typeof useGet_Lesson_By_SlugQuery>;
export type Get_Lesson_By_SlugLazyQueryHookResult = ReturnType<typeof useGet_Lesson_By_SlugLazyQuery>;
export type Get_Lesson_By_SlugQueryResult = Apollo.QueryResult<Get_Lesson_By_SlugQuery, Get_Lesson_By_SlugQueryVariables>;